...
firebase_admin.initialize_app(
    cred,
    {
        ...
        "storageBucket": "faceattendacerealtime-6254e.appspot.com",
    },
)
...
def dataset(id):
    ...
    blob = bucket.get_blob(f"Face-Recognition-System-for-Student-Attendance-main/static/Files/Images/{id}.jpg")
...
def add_user():
    ...
    if request.method == "POST":
        ...
        filename = f"{'Face-Recognition-System-for-Student-Attendance-main/static/Files/Images'}/{id}.jpg"
...
def delete_image(student_id):
    filepath = f"Face-Recognition-System-for-Student-Attendance-main/static/Files/Images/{student_id}.jpg"
